...
import com.userservice.config.SecurityConfig.GatewayAuthenticatedUser;
...
public class SecurityUtils {
    ...
    public static String getCurrentUsername() {
        ...
        if (authentication.getPrincipal() instanceof GatewayAuthenticatedUser) {
            GatewayAuthenticatedUser user = (GatewayAuthenticatedUser) authentication.getPrincipal();
    ...
    public static Optional<String> getCurrentUserId() {
        ...
        if (authentication != null && authentication.getPrincipal() instanceof GatewayAuthenticatedUser) {
            GatewayAuthenticatedUser user = (GatewayAuthenticatedUser) authentication.getPrincipal();
